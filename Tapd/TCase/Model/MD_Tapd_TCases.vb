Namespace Tapd.TCase.Model
    Public Class MD_Tapd_TCases
                ''' <summary>
        ''' 系统编号
        ''' </summary>
        ...
        ''' 用例步骤
        ''' </summary>
        ''' <returns>steps [ 用例步骤 ] By String</returns>
        ...
        ''' 用例目录
        ''' </summary>
        ''' <returns>category_id [ 用例目录 ] By String</returns>
        ...
        ''' 最后修改人
        ''' </summary>
        ''' <returns>modifier [ 最后修改人 ] By String</returns>
        ...
        ''' 用例状态
        ''' </summary>
        ''' <returns>status [ 用例状态 ] By String</returns>
        Property status As String
        ''' <summary>
        ''' 用例名称
        ''' </summary>
        ''' <returns>name [ 用例名称 ] By String</returns>
        Property name As String
        ''' <summary>
        ''' 前置条件
        ''' </summary>
        ''' <returns>precondition [ 前置条件 ] By String</returns>
        Property precondition As String
        ''' <summary>
        ''' 预期结果
        ''' </summary>
        ''' <returns>expectation [ 预期结果 ] By String</returns>
        Property expectation As String
        ''' <summary>
        ''' 用例类型
        ''' </summary>
        ''' <returns>type [ 用例类型 ] By String</returns>
        Property type As String
        ''' <summary>
        ''' 用例等级
        ''' </summary>
        ''' <returns>priority [ 用例等级 ] By String</returns>
        Property priority As String
        ''' <summary>
        ''' 自定义字段1
        ''' </summary>
        ''' <returns>custom_field_1 [ 自定义字段1 ] By String</returns>
        Property custom_field_1 As String
        ''' <summary>
        ''' 自定义字段2
        ''' </summary>
        ''' <returns>custom_field_2 [ 自定义字段2 ] By String</returns>
        Property custom_field_2 As String
        ''' <summary>
        ''' 自定义字段3
        ''' </summary>
        ''' <returns>custom_field_3 [ 自定义字段3 ] By String</returns>
        Property custom_field_3 As String
        ''' <summary>
        ''' 自定义字段4
        ''' </summary>
        ''' <returns>custom_field_4 [ 自定义字段4 ] By String</returns>
        Property custom_field_4 As String
        ''' <summary>
        ''' 自定义字段5
        ''' </summary>
        ''' <returns>custom_field_5 [ 自定义字段5 ] By String</returns>
        Property custom_field_5 As String
        ''' <summary>
        ''' 自定义字段6
        ''' </summary>
        ...
        ''' 测试用例地址
        ''' </summary>
        ''' <returns>url [ 测试用例地址 ] By String</returns>
