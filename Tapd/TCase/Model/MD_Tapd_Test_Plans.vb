Namespace Tapd.TCase.Model
    Public Class MD_Tapd_Test_Plans
                ''' <summary>
        ''' 系统编号
        ''' </summary>
        ...
        ''' 需求分类描述
        ''' </summary>
        ''' <returns>description [ 需求分类描述 ] By String</returns>
        ...
        ''' 测试负责人
        ''' </summary>
        ''' <returns>owner [ 测试负责人 ] By String</returns>
        ...
        ''' 测试类型
        ''' </summary>
        ''' <returns>type [ 测试类型 ] By String</returns>
        Property type As String
        ''' <summary>
        ''' 开始时间
        ''' </summary>
        ''' <returns>start_date [ 开始时间 ] By String</returns>
        Property start_date As String
        ''' <summary>
        ''' 结束时间
        ''' </summary>
        ''' <returns>end_date [ 结束时间 ] By String</returns>
        ...
        ''' 测试计划地址
        ''' </summary>
        ''' <returns>url [ 测试计划地址 ] By String</returns>
